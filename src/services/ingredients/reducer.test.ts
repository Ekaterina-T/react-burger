...
import {TIngredientState} from './reducer'
...
describe('Action creators for ingredients', () => {
  ...
  it('should handle successful ingredients upload', () => {
    ...
    const testAction: IGetIngredientsSuccess = { type: ActionTypes.GET_INGREDIENTS_SUCCESS, 
                         data: [{   key: "60666c42cc7b410027a1a9b6",
    ...
    const expectedState = {
        ...
        ingredientsLoadFailed: false,
        items: [{   key: "60666c42cc7b410027a1a9b6",
                    _id:"60666c42cc7b410027a1a9b6",
                    name:"Биокотлета из марсианской Магнолии",
                    type:"main",
                    proteins:420,
  ...
  it('should show ingredient details', () => {
    ...
    const initialState: TIngredientState = {
                                            ...
                                            items: [{   key: "60666c42cc7b410027a1a9b6",
                                                ...
                                                showIngredientDetails: false,
                                                activeIngredient: { key: "60666c42cc7b410027a1a9b7",
                                                                    _id:"60666c42cc7b410027a1a9b7",
                                                                    name:"Соус Spicy-X",
                                                                    type:"sauce",
                                                                    proteins:30,
  ...
  it('should set active ingredient', () => {
    ...
    const testAction: ISetActiveIngredient = { type: ActionTypes.SET_ACTIVE_INGREDIENT, 
                         value: { key: "60666c42cc7b410027a1a9b7",
                                    _id:"60666c42cc7b410027a1a9b7",
                                    name:"Соус Spicy-X",
                                    type:"sauce",
                                    proteins:30,
    ...
    const initialState: TIngredientState = {
        ...
        showIngredientDetails: false,
        activeIngredient: { key: "60666c42cc7b410027a1a9b6",
                            _id:"60666c42cc7b410027a1a9b6",
                            name:"Биокотлета из марсианской Магнолии",
                            type:"main",
                            proteins:420,
