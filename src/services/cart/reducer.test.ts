...
describe('Action creators for cart', () => {
  ...
  it('should create an action with correct price', () => {
    ...
    const testAction: IUpdateCart = {type: ActionTypes.UPDATE_CART,
                        updatedCart: {bun: {  key: "60666c42cc7b410027a1a9b1",
                                      ...
                                      fillings: [{key: "60666c42cc7b410027a1a9b6",
    ...
    const expectedState = {
        ...
        bun: {  key: "60666c42cc7b410027a1a9b1",
                _id:"60666c42cc7b410027a1a9b1",
                name: "Краторная булка N-200i",
                type: "bun",
                proteins:80,
